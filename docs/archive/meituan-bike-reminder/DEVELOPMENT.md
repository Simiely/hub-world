...
---
> 🔗 [查看 GitHub 原文](https://github.com/Simiely/meituan-bike-reminder/blob/main/DEVELOPMENT.md)
...
- ⚠️ **踩坑记录：曾试过「扫码连续两次（间隔 300/700ms 重踢相机）」规避黑屏，真机（HyperOS 3）验证无效，已回退为单次扫码。** 勿再重复此实验——两次投递在目标机上并未改善黑屏，反而增加复杂度。
